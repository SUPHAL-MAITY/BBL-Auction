...
<div className="contact_content">
        <h1 className="contact_title">Terms & Conditions</h1>
        <p className="contact_para"></p>
        <p className="contact_para">

            These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
agreement by and between SOURAV MUKHERJEE, ( “Website Owner” or “we” or “us” or “our”) and
...
jurisdiction of the courts in Durgapur, West Bengal
